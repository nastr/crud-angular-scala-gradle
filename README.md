...
```
java -jar build/libs/crud-angular-0.0.1-SNAPSHOT.jar
```
...
`curl https://start.spring.io/starter.tgz -d type=gradle-project -d groupId=com.nastrsoft -d artifactId=spring-angular | tar -xzvf -`
...
```
package com.nastrsoft.springangular.controller;
